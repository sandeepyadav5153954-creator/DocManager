...
with tabs[0]:
    ...
    if st.button("Upload"):
        analytics.record_app_visit("upload_click") # see in analytics.py
        # if uploaded_file and tags and description:
        if uploaded_file:
            service.upload_document(uploaded_file, tags, description, lecture_date) # see in services.py 
...
with tabs[1]:
    ...
    if st.session_state.reader_mode and st.session_state.selected_doc:
        ...
        # 20260619153353_Ultimate Data Science & GenAI Bootcamp V2.0
